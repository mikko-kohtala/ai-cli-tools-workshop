...
/** biome-ignore-all lint/suspicious/noDocumentCookie: shadcn */
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<"main">>(({ className, ...props }, ref) => (
  <main
    className={cn(
      ...
      "md:peer-data-[side=right]:mr-[--sidebar-width] md:peer-data-[state=collapsed]:peer-data-[side=right]:mr-0",
      className
    )}
    ref={ref}
    {...props}
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => (
  <div className={cn("flex flex-col gap-2 p-2", className)} data-sidebar="footer" ref={ref} {...props} />
));
