            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <ol className="list-decimal space-y-4 pl-6">
                  ...
                  <li>
                    <p>
                      Start a new Codex CLI session and ask it to explain what it can do for you. Take note of its
                      response.
                    </p>
                  </li>
                  <li>
                    <p>
                      Try asking Codex CLI to help you with a simple task, such as creating a new file or explaining a
                      code snippet.
                    </p>
                  </li>
                  <li>
