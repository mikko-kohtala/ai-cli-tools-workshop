  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      <div className="space-y-4">
        ...
        <p className="text-lg">
          Explore <code>codex exec</code> for non-interactive automation by converting log output into a structured incident
          summary.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <p>
            Run Codex CLI in automation mode to transform production logs into a JSON incident report and a ready-to-send status
            update. Practice JSON streaming, schema enforcement, and resuming runs.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <ol className="list-decimal space-y-4 pl-6">
            ...
            <li>
              <p>
                Draft a short <code>AGENTS.md</code> describing the output you expect: a JSON payload with impacted systems,
                primary errors, and recommended follow-up actions.
              </p>
            </li>
            <li>
              <p>
                Create a JSON Schema file (e.g. <code>incident-schema.json</code>) that defines required fields such as
                <code>summary</code>, <code>impacted_services</code>, and <code>next_steps</code>. You can start from the
                snippet in the solution tab.
              </p>
            </li>
            <li>
              <p>
              ...
              <p className="mt-2 text-muted-foreground text-sm">
                Inspect the streamed JSONL output and capture the <code>agent_message</code> containing the structured result.
              </p>
            </li>
            <li>
              <p>
                Resume the run to create a status update Markdown file:</p>
              <div className="rounded bg-white p-3 font-mono text-sm dark:bg-slate-950">
                <div>codex exec resume --last "Write status-update.md for stakeholders referencing the JSON summary"</div>
              </div>
            </li>
            <li>
              <p>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li><code>codex exec</code> automates workflows without the interactive TUI</li>
              <li><code>--json</code> streams machine-readable events you can pipe elsewhere</li>
              <li><code>--output-schema</code> enforces structured responses that integrate cleanly with tooling</li>
              <li><code>codex exec resume</code> keeps conversation context for follow-up tasks</li>
              <li>Use <code>--model</code> to try higher reasoning levels when the summary needs deeper insight</li>
            </ul>
          </div>
        ...
        <div className="space-y-4">
            ...
            <div className="rounded-lg border bg-neutral-50 p-4 dark:bg-neutral-900/30">
              ...
              <ul className="list-disc space-y-1 pl-6 text-sm">
                ...
                <li>Create a stakeholder-facing <code>status-update.md</code> derived from the structured data</li>
                <li>Understand how to resume non-interactive runs for iterative automation</li>
                <li>Know when to enable <code>--full-auto</code> and model overrides</li>
              </ul>
            </div>
          </div>
        </div>
