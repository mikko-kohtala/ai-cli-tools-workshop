  ...
  return (
    <div className="flex flex-col gap-8 p-8">
      <div className="space-y-4">
        ...
        <p className="text-lg">
          Explore Codex CLI&apos;s non-interactive mode to batch-generate insights, summaries, and follow-up actions
          from a set of Markdown notes.
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <p>
            Use <code>codex exec</code> to produce a daily summary, action items, and a follow-up agenda based on
            workshop notes, then review the generated files.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <ol className="list-decimal space-y-4 pl-6">
              ...
              <li>
                <p>
                  Add a small <code>AGENTS.md</code> reminding Codex to treat the folder as read-only for source notes
                  and to write new output files instead of editing the originals. Re-run <code>codex exec</code> to
                  confirm the instructions stick.
                </p>
              </li>
              <li>
                <p>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <ul className="list-disc space-y-2 pl-6">
              <li>
                <code>codex exec</code> runs a single request end-to-end without opening the TUI
              </li>
              <li>
                <code>--model</code> lets you dial up reasoning depth when you need richer output
              </li>
              <li>
                <code>AGENTS.md</code> still applies to automation runs
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border bg-neutral-50 p-4 dark:bg-neutral-900/30">
              ...
              <ul className="list-disc space-y-1 pl-6 text-sm">
                <li>
                  Know how to automate Codex responses with <code>codex exec</code>
                </li>
                <li>
                  Generate <code>summary.md</code> and <code>agenda.md</code> from workshop notes
                </li>
                <li>
                  See how <code>AGENTS.md</code> influences automation runs
                </li>
