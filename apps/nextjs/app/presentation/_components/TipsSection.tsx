...
const workflowOptimizations = [
  {
    ...
    command: 'codex checkpoint create "before-refactor"',
  },
  {
  ...
  {
    title: "Use .codexignore",
    description: "Exclude large or irrelevant files from the agent's context.",
    command: "# .codexignore\ndist/\nbuild/\n*.log\ncoverage/",
  },
];
...
const debuggingTips = [
  {
    ...
    command: "codex --verbose",
  },
  {
    title: "Check the agent's understanding",
    description: "If results aren't what you expected, ask Codex to explain its reasoning.",
    example:
      'You: "Why did you choose that approach?"\nCodex: "I used React Query because I saw it\'s already used in UserList.tsx..."',
  },
  {
    title: "View the context window",
    description: "See what files the agent has loaded into its context.",
    command: "codex context show",
  },
];
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Once you're comfortable with the basics, these advanced techniques will help you work even faster. These
              are lessons learned from developers who use Codex CLI every day.
            </p>
          </CardContent>
        </Card>
      </div>
