  ...
  return (
    <section id="overview" className="mb-16">
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        <div>
          <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-300">Outcomes</h4>
        ...
        <div>
          <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-300">Principles</h4>
          <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
      ...
      <p className="mt-6 text-sm text-gray-600 dark:text-gray-400">Examples only—this ecosystem moves quickly and names/models evolve. Focus on capabilities and fit.</p>
    </section>
  );
}
