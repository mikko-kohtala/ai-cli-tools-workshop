  ...
  return (
    <section className="mb-16 scroll-mt-16" id="communication">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h2 className="font-bold text-4xl">Communication Patterns</h2>
      </div>
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Well-designed AI CLI responses are concise, scannable, and action-oriented. Understanding how they
              communicate helps you work faster and reduces cognitive load during sessions.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-foreground/70 text-sm">
              Good agents avoid long-winded explanations unless you ask for details. Responses use headers, bullet
              points, and clear sections so you can quickly understand what happened.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-foreground/70 text-sm">
              When agents reference files, they should include full paths and often precise line numbers. Many terminals
              make these clickable, allowing you to jump directly to relevant code.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-foreground/70 text-sm">
              Instead of dumping hundreds of lines of logs, the agent should summarize what matters: Did it succeed?
              Were there errors? What changed?
            </p>
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                <p className="mb-2 font-semibold text-sm">✅ Agent summary</p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-foreground/70 text-sm">
              Agents use Markdown-style formatting to make code stand out from prose. Code blocks use syntax
