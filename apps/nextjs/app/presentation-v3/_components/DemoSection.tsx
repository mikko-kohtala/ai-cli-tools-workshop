  ...
  return (
    <section className="mb-16 scroll-mt-16" id="demo">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h2 className="font-bold text-4xl">Demo Flow</h2>
      </div>
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Let's walk through a complete development workflow using an AI CLI. This example demonstrates how the
              concepts we covered come together in practice.
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <div className="rounded bg-slate-50 p-4 dark:bg-slate-900/30">
                    <p className="mb-2 font-semibold text-sm">Agent's generated plan:</p>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <pre className="rounded bg-slate-50 p-3 text-sm dark:bg-slate-900/30">
                        ...
                        <code className="text-blue-600">Agent:</code>{" "}
                        <code>
                          {" "}
