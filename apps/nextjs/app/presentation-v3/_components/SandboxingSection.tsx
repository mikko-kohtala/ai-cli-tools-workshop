...
const sandboxingGuidelines = [
  {
    ...
    description:
      "Check your tool's sandbox or permissions mode via config or flags. This tells you what level of access the agent has.",
  },
  {
...
const configExamples = [
  {
    ...
    command: "<cli> config set sandbox workspace-write",
  },
  {
  ...
  return (
    <section className="mb-16 scroll-mt-16" id="sandboxing">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h2 className="font-bold text-4xl">Sandboxing & Permissions</h2>
      </div>
        ...
        <Card>
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed">
              Sandboxing creates a protective boundary around your project so the agent can only perform actions you've
              explicitly allowed. Treat it like a security guard that checks every request before letting it through.
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-foreground/70 text-sm">
                When trying a new tool or repo, start with 'read-only' or 'workspace-write'. You can always escalate
                permissions if needed, but it's much harder to undo accidental changes.
              </p>
            </div>
          </div>
        </CardContent>
