import { Calendar, Code2, ExternalLink, Gamepad2, Github, Presentation, Sparkles, Zap } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg border bg-white p-4 dark:bg-slate-900">
              ...
              <p className="text-muted-foreground text-xs">Get started with Codex CLI and learn essential commands</p>
            </div>
            ...
            <div className="rounded-lg border bg-white p-4 dark:bg-slate-900">
              ...
              <p className="text-muted-foreground text-xs">Build any project using AGENTS.md and constraints</p>
            </div>
            ...
            <div className="rounded-lg border bg-white p-4 dark:bg-slate-900">
              ...
              <p className="text-muted-foreground text-xs">Custom prompts, automation, and MCP servers</p>
            </div>
            ...
            <div className="rounded-lg border bg-white p-4 dark:bg-slate-900">
              ...
              <p className="text-muted-foreground text-xs">Build a retro game and share with the workshop</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border bg-gradient-to-br from-slate-50 to-slate-100 p-6 dark:from-slate-900/50 dark:to-slate-900/30">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="flex gap-3">
              <span className="flex-shrink-0 text-blue-600 leading-5 dark:text-blue-400">✓</span>
              <span className="text-sm">
                Overview of AI CLI tools ecosystem (Codex CLI, Claude Code, Gemini CLI, Amp)
              </span>
            </div>
            <div className="flex gap-3">
              <span className="flex-shrink-0 text-blue-600 leading-5 dark:text-blue-400">✓</span>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">25-minute overview of the AI CLI tools landscape and key concepts</p>
            </div>
          </Link>
