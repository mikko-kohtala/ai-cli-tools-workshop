      ...
      <SidebarInset>
        <header className="flex h-16 shrink-0 items-center gap-2 border-b px-4">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbPage>AI CLI Tools Workshop</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <div className="space-y-2">
                ...
                <p>Get hands-on experience with Codex CLI through practical coding exercises.</p>
              </div>
            </Link>
          </div>
          ...
          <div className="rounded-lg border p-6">
            ...
            <div className="space-y-4">
              <p>
                ...
                presentation provides an overview of the landscape, while the tasks give you hands-on experience with
                Codex CLI.
              </p>
